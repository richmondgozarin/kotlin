...
package org.jetbrains.kotlin.backend.jvm.lower.jvm.internal
 ...
 */
internal class TypeOperatorLowering(val context: BackendContext) : FunctionLoweringPass {
...
private class TypeOperatorTransformer(val context: BackendContext, val function: IrFunctionSymbol) : IrElementTransformerVoid() {
